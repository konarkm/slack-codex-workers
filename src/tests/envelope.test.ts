...
describe("renderEnvelope", () => {
  ...
  it("puts unseen thread history before the message and says how much is missing", () => {
    ...
    // The opening message stays, since it says what the thread is about; the rest of the room goes to the newest.
    expect(threadContext).toEqual({ kind: "thread", total: 3, messages: [{ author: "Priya (U2)", ts: "1726600000.000001", text: "m1" }, { author: "Priya (U2)", ts: "1726600000.000003", text: "m3" }] });
